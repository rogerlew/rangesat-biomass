...
class RasterDatasetInterpolator:
    ...
    @property
    def wgs_bbox(self):
        west, south = transform(self.proj, self.wgs84, self.left, self.lower)
        east, north = transform(self.proj, self.wgs84, self.right, self.upper)
